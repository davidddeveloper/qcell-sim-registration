"""
Django settings for sim_registration project.
...
ALLOWED_HOSTS = ["192.168.100.181", "192.168.0.69", "localhost", "127.0.0.1", "192.168.100.180", "192.168.0.58"]
...
WSGI_APPLICATION = "sim_registration.wsgi.application"
