...
class Customer(models.Model):
    ...
    agent = models.ForeignKey(to=User, verbose_name="Agent", blank=True, on_delete=models.CASCADE, null=True, blank=True, default=User.objects.get(username="david").id)
